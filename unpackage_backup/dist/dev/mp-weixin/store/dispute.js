...
const useDisputeStore = common_vendor.defineStore("dispute", {
  state: () => ({
    disputeList: [],
    // 纠纷列表
    currentDispute: null,
...
exports.useDisputeStore = useDisputeStore;
//# sourceMappingURL=../../.sourcemap/mp-weixin/store/dispute.js.map
