...
function initRuntimeSocketService() {
  const hosts = "172.21.192.1,192.168.81.1,192.168.47.1,192.168.110.51,127.0.0.1";
  const port = "8090";
  const id = "mp-weixin_4RbkKs";
...
const globalStyle = {
  navigationBarTextStyle: "white",
  navigationBarTitleText: "矛盾纠纷管理系统",
  navigationBarBackgroundColor: "#1677ff",
...
const b = true, E = "mp-weixin", A = T(define_process_env_UNI_SECURE_NETWORK_CONFIG_default), P = E, C = T('{"address":["127.0.0.1","172.21.192.1","192.168.81.1","192.168.47.1","192.168.110.51"],"servePort":7000,"debugPort":9000,"initialLaunchType":"local","skipFiles":["<node_internals>/**","C:/Users/yuchen/Downloads/HBuilderX.4.87.2025121004/HBuilderX/plugins/unicloud/**/*.js"]}'), O = T('[{"provider":"aliyun","spaceName":"yuchen","spaceId":"mp-0aec74b7-676a-4a0e-91f3-90d9dbc942df","clientSecret":"TvKL3D67uodrQ5ZsERpcfw==","endpoint":"https://api.next.bspapp.com"}]') || [];
let N = "";
try {
  N = "__UNI__CED3000";
} catch (e2) {
